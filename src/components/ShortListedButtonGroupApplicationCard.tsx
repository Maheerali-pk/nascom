...
interface ShortListedButtonGroupApplicationCardProps {
...
const ShortListedButtonGroupApplicationCard: React.FC<
   ShortListedButtonGroupApplicationCardProps
> = (props) => {
...
export default ShortListedButtonGroupApplicationCard;
